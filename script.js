...
const translations = {
    ...
    'v-b3-4': { en: '🧠 AI labels can change how people evaluate music.', tr: '🧠 Beyniniz biliyor' },
    'v-b3-4d': { en: 'The moment you see the \'AI\' word, the right side of your prefrontal cortex showed a higher HbO2 response pattern — like you\'re switching into critical-thinking mode.', tr: '\'YZ\' kelimesini gördüğünüz an, sağ prefrontal korteksiniz aydınlanıyor — sanki eleştirel düşünme moduna geçiyorsunuz.' },
    ...
    'v-b6-3': { en: '🧬 People may use source labels as a shortcut when evaluating creative work:', tr: '🧬 Beyninizin yerleşik bir YZ filtresi var:' },
    ...
    en: {
        ...
        "exp-final-sub": '"AI" labeled music activated the brain\'s right-prefrontal source-evaluation processes <span class="exp-highlight">a higher Right PFC HbO2 peak in the study sample</span>, even when the sound was identical.',
